...
public class Ellipse implements Shape {
	 ...
	 * Parameters are x1 and y1 for one point, color
	 */
	 ...
	 * Params: x1y1 one corner, x2y2 other corner, color
	 */
	...
	/**
	 * Tests if ellipse contains point
	 */
	@Override
	...
	/**
	 * Broadcasts ellipse properties from client to server
	 */
	@Override
