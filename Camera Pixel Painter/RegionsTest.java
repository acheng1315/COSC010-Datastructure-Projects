...
public class RegionsTest extends DrawingGUI {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
//                new RegionsTest("smiley", new RegionFinder(loadImage("Pset1/smiley.png")), new Color(0, 0, 0));
                new RegionsTest("baker", new RegionFinder(loadImage("Pset1/baker.jpeg")), new Color(130, 100, 100));
            }
        });
    }
}